...
from .utill import melt_cols, make_DP_customer_neutral
from plotly.io import to_json


def get_customer_neutral_data():
    ...
    demand_cn = pd.DataFrame(customer_neutral)
    demand_sp = pd.DataFrame(customer_specific)
    demand = pd.concat([demand_sp, demand_cn])
    ...
    graph_data=make_DP_customer_neutral(product_segment_no,product_no,material_no,demand,demand_DataType)
