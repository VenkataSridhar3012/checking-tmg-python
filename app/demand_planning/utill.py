 ...
 def make_DP_overview(
   product_segment_no,
    ...
    if product_segment_no:
        demand_plot = demand[demand.product_segment_no == product_segment_no]
        ...
        demand_plot = demand[demand.product_no == product_no]
        # demand_prev_scenario_plot = demand_prev_scenario[
        ...
        demand_plot = demand[demand.material_no == material_no]
        # demand_prev_scenario_plot = demand_prev_scenario[
    ...
    file_name = "figure1.png"  # Change the file name and format as needed
    current_directory = os.getcwd() # This will save the image in the current working directory
    file_path = os.path.join(current_directory, file_name)
    # Save the figure to the specified file path and format
    #
